...
DROP TABLE IF EXISTS tenmo_transfer, tenmo_account, tenmo_user, transfer_type, transfer_status;
...
CREATE TABLE tenmo_transfer (
	...
	CONSTRAINT FK_transfer_account_from FOREIGN KEY (account_from) REFERENCES tenmo_account (account_id),
	CONSTRAINT FK_transfer_account_to FOREIGN KEY (account_to) REFERENCES tenmo_account (account_id),
